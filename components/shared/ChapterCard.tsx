...
export default function ChapterCard({
  ...
  return (
    <div
      onClick={onClick}
      className={`group relative bg-card rounded-2xl overflow-hidden transition-all duration-300 ${onClick ? 'cursor-pointer hover:-translate-y-1' : ''
        } ${isSelected
    ...
    >
      ...
      <div className="relative p-6 flex flex-col h-full">
        ...
        <div className="space-y-3 mb-4 flex-grow">
          {president && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">President</p>
                <p className="text-sm font-semibold text-foreground">{president}</p>
              </div>
            </div>
          )}
          ...
          {admin && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">Head of Operations</p>
        ...
        <div className="flex items-center gap-2 text-sm font-semibold text-foreground mb-4 bg-primary/5 px-3 py-2 rounded-lg w-full">
          ...
          <span>{memberCount > 0 ? memberCount.toLocaleString() : 0} active members</span>
        </div>
