...
export default function SpecializationsSection({ profile }: SpecializationsSectionProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-6 shadow-sm">
      <h2 className="text-lg font-semibold text-foreground mb-4">{t('profile.specializations.title')}</h2>
      <div className="space-y-4">
        {profile.writerSpecialization && (
          <div>
             <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">{t('profile.specializations.writer')}</p>
        ...
        {profile.crewSpecializations && profile.crewSpecializations.length > 0 && (
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">{t('profile.specializations.crew')}</p>
        ...
        {profile.businessSpecializations && profile.businessSpecializations.length > 0 && (
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">{t('profile.specializations.business')}</p>
             <div className="flex flex-wrap gap-2">
