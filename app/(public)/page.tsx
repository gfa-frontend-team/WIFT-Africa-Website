...
export default function LandingPage() {
  ...
  const featuredMembers = [
    ...
    },
    {
      ...
      verified: true,
      quote: 'Three major collaborations started through my WIFT profile. The visibility is real — and its global.'
    }
  ]
        ...
        <div className="container mx-auto px-4 py-20 lg:py-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="/register"
                className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center whitespace-nowrap rounded-lg text-lg font-medium transition-colors px-8 py-4"
              >
                Join the Community - Free
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <button className="border-2 border-white/30 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white inline-flex items-center justify-center whitespace-nowrap rounded-lg text-lg font-medium transition-colors px-8 py-4">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                Join 300+ verified professionals who've found their tribe, built lasting connections, and amplified their voices through WIFT Africa.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Link
                  href="/register"
                  className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center whitespace-nowrap rounded-lg text-xl font-medium transition-colors px-10 py-5"
                >
                ...
                <Link
                  href="/login"
                  className="border border-input bg-background hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center whitespace-nowrap rounded-lg text-xl font-medium transition-colors px-10 py-5"
                >
                  Sign In
                </Link>
              </div>
